...
public class Transaction {
  ...
  public Transaction(
      float value, String paidTo, String desc, String date, Timestamp dateCreated, int budget) {
    tValue = value;
    tPaidTo = paidTo;
    tDesc = desc;
    tDate = dateParser(date);
  ...
  private static LocalDate dateParser(String date) {
    ...
    DateTimeFormatter formatterDisplayed =
        DateTimeFormatter.ofPattern(DBHelper.DATE_FORMAT_DISPLAYED);
